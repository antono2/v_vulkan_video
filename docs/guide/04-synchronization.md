...
[the video queue submission](../../player_presentation.v#L173) sends that command buffer to
the decode queue and signals a semaphore. It then submits a graphics command
...
its own [acquire](../../app.v#L386) and
[render-complete](../../app.v#L480) semaphores, managed in
[`VideoDecodeApp.run`](../../app.v#L367).
...
ordered graphics submissions. [Resize](../../app.v#L504) waits for the device to become idle
