...
offset and size alignments. [`write_video_frame`](../../player_decode.v#L521) fills
...
separate bounded pool of [`OutputImage`](../../video_player.v#L173) objects,
[allocated after decoder setup](../../video_player.v#L521). The
...
reference storage. [`copy_decoded_frame_to_output`](../../player_decode.v#L187)
