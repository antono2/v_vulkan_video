...
[`VideoPlayer.prepare`](../../video_player.v#L560) calls
...
[non-MP4 input](../../video_player_test.v#L505),
[truncation](../../video_player_test.v#L544), and
[short reads](../../video_player_test.v#L524). In another project, input
...
[PPS preflight](../../h264_parameter_sets.v#L180) check syntax length and the
fixed-array limits of the pinned H.264 parser before calling it. Unsupported
slice groups fail with a clear error. Parameter sets are
[looked up by their H.264 IDs](../../h264_slice.v#L5), so a legal nonzero ID
does not have to equal its position in the MP4 parameter-set list.
...
picture identity. The [four-slice fixture test](../../video_player_test.v#L454)
...
tests assert the [early sequence](../../video_player_test.v#L468) and
...
[ordering test](../../video_player_test.v#L250) covers a reset followed by a
...
[unit case](../../video_player_test.v#L169) shows why a nonreference picture can
