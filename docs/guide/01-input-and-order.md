...
[`VideoPlayer.prepare`](../../video_player.v#L576) calls
...
[non-MP4 input](../../video_player_test.v#L556),
[truncation](../../video_player_test.v#L595), and
[short reads](../../video_player_test.v#L575). In another project, input
...
The [SPS preflight](../../h264_parameter_sets.v#L114) and
[PPS preflight](../../h264_parameter_sets.v#L189) check syntax length, reference
...
[maps those IDs to serialized offsets](../../video_player.v#L439) when recording
...
[ID mapping test](../../video_player_test.v#L169) and
[truncation and mutation test](../../video_player_test.v#L189) exercise these
boundaries without a GPU. A [five-frame fixture test](../../video_player_test.v#L671)
...
for both [parsing](../../mp4_parser.v#L526) and
[GPU upload](../../player_decode.v#L560). Samples containing only metadata
are [left out of the picture list](../../mp4_parser.v#L712), keeping slice
...
The parser [counts every slice's Annex B bytes](../../mp4_parser.v#L576)
...
picture identity. The [four-slice fixture test](../../video_player_test.v#L503)
...
[the display-order pass](../../mp4_parser.v#L726) assigns a display order to each
...
tests assert the [early sequence](../../video_player_test.v#L519) and
...
[ordering test](../../video_player_test.v#L299) covers a reset followed by a
...
[unit case](../../video_player_test.v#L218) shows why a nonreference picture can
